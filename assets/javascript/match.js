...
$(document).ready(function () {
  ...
  var maleRange = 5
  var femaleRange = 5
  // var testResponseLength = 20;// test data, change in prod
  ...
  // 2/16/2019 Error Handling Routine Updated
  ...
  function loadHeroData () {
    ...
    for (var i = 0; i < /* testResponseLength */data.length; i++) {
      ...
      // console.log("Hero Gender = " + heroGender);
      if (isGenderEqual) {
        // console.log('GENDER IS EQUAL, ID = ' + heroId + ' Hero Name = ' + data[i].name + ' matchIndex = ' + i);
        /******************************************
  ...
  function getHeroFromJson (index) {
    ...
    heroMatchName = data[matchIndex].name
    // console.log("Matching Hero Name = " + heroMatchName);
    heroMatchPhoto = data[matchIndex].images.sm
    // console.log("Hero Inmage= " + heroMatchPhoto);
    heroMatchInt = data[matchIndex].powerstats.intelligence
    // console.log("Hero Intelligence = " + heroMatchInt);
    heroMatchStr = data[matchIndex].powerstats.strength
    // console.log("Hero Strength = " + heroMatchStr);
    heroMatchSpd = data[matchIndex].powerstats.speed
    // console.log("Hero Speed = " + heroMatchSpd);
    heroMatchDur = data[matchIndex].powerstats.durability
    // console.log("Hero Durability = " + heroMatchDur);
    heroMatchPow = data[matchIndex].powerstats.power
    // console.log("Hero Power = " + heroMatchPow);
    heroMatchCmb = data[matchIndex].powerstats.combat
